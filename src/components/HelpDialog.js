...
// Custom colors to match the new theme
const customColors = {
  brown: {
    main: '#402d11',
    light: '#e3b25e',
...
export default function HelpDialog({ open, onClose }) {
  return (
    <Dialog 
      ...
      PaperProps={{
        sx: {
          bgcolor: customColors.background.paper,
          backgroundImage: 'none'
        }
      }}
    >
      <DialogTitle sx={{ 
        bgcolor: customColors.brown.main,
      ...
      <DialogContent sx={{ p: 4, bgcolor: customColors.background.paper }}>
        <Typography 
          variant="body1" 
          paragraph
          sx={{ 
        ...
        <Box sx={{ 
          p: 3, 
          mb: 4, 
          bgcolor: customColors.background.dark,
          borderRadius: 2,
          ...
          <Typography variant="body2" sx={{ color: customColors.text.primary }}>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <Step key={step.label} active={true}>
                  ...
                  StepIconComponent={() => (
                    <Box
                      sx={{
                        ...
                        height: 40,
                        borderRadius: '50%',
                        bgcolor: customColors.green.main,
                        display: 'flex',
                        alignItems: 'center',
                ...
                >
                  <Typography variant="h6" sx={{ color: customColors.text.secondary }}>
                    {step.label}
                  </Typography>
                </StepLabel>
                <StepContent>
        ...
        <Box sx={{ 
          ...
          <Typography variant="h6" gutterBottom sx={{ color: customColors.text.secondary }}>
            Best Practices
          </Typography>
          <Typography variant="body1" sx={{ 
            color: customColors.text.primary,
      ...
      <DialogActions sx={{ p: 3, bgcolor: customColors.background.paper }}>
        <Button 
          onClick={onClose}
          sx={{ 
            color: customColors.text.secondary,
            '&:hover': {
              backgroundColor: customColors.brown.dark
            }
          }}
        >
          Close
